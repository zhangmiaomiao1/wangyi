    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function lazyLoad(destiny){
            ...
            destiny.find('img1[data-src], source[data-src], audio[data-src], iframe[data-src]').each(function(){
        ...
        */
        function destroyStructure(){
            ...
            container.find('img1[data-src], source[data-src], audio[data-src], iframe[data-src]').each(function(){
                $(this).attr('src', $(this).data('src'));
                $(this).removeAttr('data-src');
            });
